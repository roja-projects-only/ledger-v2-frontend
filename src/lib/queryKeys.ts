...
export const queryKeys = {
  ...
  debts: {
    ...
    transactionsRoot: () => [...queryKeys.debts.all, 'transactions'] as const,
    transactions: (filters?: Record<string, unknown>) => [...queryKeys.debts.transactionsRoot(), filters] as const,
